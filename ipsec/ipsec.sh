...
# ==================================================
# Link Hosting Kalian
bbxvpn="raw.githubusercontent.com/BrebesBlackXploit/fsh/main/ipsec"
...
wget -O /usr/bin/addl2tp https://${bbxvpn}/addl2tp.sh && chmod +x /usr/bin/addl2tp
wget -O /usr/bin/dell2tp https://${bbxvpn}/dell2tp.sh && chmod +x /usr/bin/dell2tp
wget -O /usr/bin/addpptp https://${bbxvpn}/addpptp.sh && chmod +x /usr/bin/addpptp
wget -O /usr/bin/delpptp https://${bbxvpn}/delpptp.sh && chmod +x /usr/bin/delpptp
wget -O /usr/bin/renewpptp https://${bbxvpn}/renewpptp.sh && chmod +x /usr/bin/renewpptp
wget -O /usr/bin/renewl2tp https://${bbxvpn}/renewl2tp.sh && chmod +x /usr/bin/renewl2tp
